class TrainTicket{
    constructor(type,destination, date,time,price){
        this.type = type;
...
const trainTickets = [
    ...
    new TrainTicket('Pretoria', 'Botswana', '2024-08-12', '08:00', 500),
    new TrainTicket('Pretoria', 'Botswana', '2024-08-20', '09:00', 550),
    new TrainTicket('Pretoria', 'Botswana', '2024-09-05', '10:00', 600),
    new TrainTicket('Pretoria', 'Botswana', '2024-09-15', '11:00', 650),

    // Johannesburg to Free State
    new TrainTicket('Johannesburg', 'Free State', '2024-08-13', '07:30', 470),
    new TrainTicket('Johannesburg', 'Free State', '2024-08-25', '09:30', 490),
    new TrainTicket('Johannesburg', 'Free State', '2024-09-08', '11:00', 520),
    new TrainTicket('Johannesburg', 'Free State', '2024-09-22', '13:00', 550),

    // Upington to Cape Town
    new TrainTicket('Upington', 'Cape Town', '2024-08-14', '06:00', 600),
    new TrainTicket('Upington', 'Cape Town', '2024-08-28', '07:30', 620),
    new TrainTicket('Upington', 'Cape Town', '2024-09-10', '08:00', 640),
    new TrainTicket('Upington', 'Cape Town', '2024-09-30', '09:00', 670),

    // Pietermaritzburg to Welkom
    new TrainTicket('Pietermaritzburg', 'Welkom', '2024-08-16', '08:00', 460),
    new TrainTicket('Pietermaritzburg', 'Welkom', '2024-08-27', '09:00', 490),
    new TrainTicket('Pietermaritzburg', 'Welkom', '2024-09-11', '10:00', 530),
    new TrainTicket('Pietermaritzburg', 'Welkom', '2024-09-20', '11:00', 560)
];
...
function proceedToCheckout(){
    ...
    trainTickets.forEach(ticket =>{
        const identifier = `${ticket.type}-${ticket.destination}-${ticket.date}-${ticket.time}-${ticket.price}`
